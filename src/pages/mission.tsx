...
const MISSION_PAGE: React.StatelessComponent = () => (
  <Layout imageBg={false} id="mission-view">
    ...
    <Container>
      <Heading1 text="Mission Statement" />
      ...
      <MissionBlock>
        CSDB was not designed to make us rich. In fact, we hope that the project can run primarily
        on donations and benefit from community participation in the form of bounties. Stopping
      ...
      <MissionBlock>
        CSDB aims to be clear, fair, and transparent with regards to user privacy, user reporting,
        and blacklisting choices. You can read MyCrypto’s{' '}
      ...
      <MissionBlock>
        ...
        nor sell visitor information with third parties without the explicit consent of the visitor
        or as is required by law. We utilize a minimal, self-hosted analytics platform to help us
        improve our product, including which features people use and how many views pages have, but
        we do not collect any personally-identifiable information from visitors of our products.
      </MissionBlock>
      ...
      <MissionBlock>
        ...
        enforcement agencies, and related organizations to prevent and terminate phishing, theft,
        and scams, assist in identifying and potentially leading to the arrest of these scams’
        operators, as well as generally protecting users in the cryptocurrency ecosystem.
      </MissionBlock>
      <MissionBlock>
        <a href="https://etherscamdb.info" target="_blank" rel="noreferrer">
          EtherScamDB.info
        ...
        allows any person to make a report (collectively these are the "Raw Reports") regarding
        items such as suspicious website URLs, suspicious cryptocurrency addresses, and scams being
      ...
      <MissionBlock>
        ...
        reasonably necessary for the CryptoScamDB team to perform its business operations
        effectively. The information gathered via the Raw Reports is used to create and maintain
        various databases of aggregate information (the "Aggregate Data").
      </MissionBlock>
      <MissionBlock>
        The Raw Reports are normally not shared with, nor sold to any third party without the
        explicit written permission of the reporter. However, Raw Reports may be shared with a third
        party as is required under applicable laws or regulations, or as is deemed necessary by
        MyCrypto to best fulfill its goal of protecting the safety and security of Users across the
      ...
      <MissionBlock>
        ...
        immediately destroy any irrelevant or sensitive personal information, it is at the User's
        sole discretion to provide this information. Note that MyCrypto is not liable for any
        information submitted by the User, and the User submits such information at her or his own
        risk.
      </MissionBlock>
      <MissionBlock>
