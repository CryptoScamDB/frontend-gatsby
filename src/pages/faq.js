...
const FaqPage = () => (
  <Layout id="faq-view">
    ...
    <Faq question="How to protect myself against scammers?" answer={[
    ...
    <Faq question="How can I join the fight?" answer={[
    ...
    <Faq question="Can I use the data from this project?" answer={[
      `Yes, you can either download the raw blacklist and whitelist files or take a look at our API`
    ]}></Faq>
    <Faq question="Are the reports open source? Where do they go?" answer={[
    ...
    <Faq question="Why was this database created" answer={[
    ...
    <div>
      If you have any other questions and would like to get in contact with us, please shoot
