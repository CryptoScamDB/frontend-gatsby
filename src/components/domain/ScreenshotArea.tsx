...
export default class ScreenshotArea extends Component<Props, State> {
  ...
  constructor(props: Props) {
    ...
    this.state = {
      currentImage: 0,
      totalImages: this.props.images.length - 1
    };
  }
  ...
  nextImage() {
    ...
    const nextImage = currentImage + 1 > totalImages ? 0 : currentImage + 1;
  ...
  prevImage() {
    const { currentImage, totalImages } = this.state;
    const nextImage = currentImage - 1 < 0 ? totalImages : currentImage - 1;
